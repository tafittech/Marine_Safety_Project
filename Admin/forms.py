...
class StudentUpdateForm(ModelForm):
    ...
    class Meta:
        ...
        fields =[
            'first_name','last_name', 'image_photo','address',
            'occupation', 'gender','date_of_birth','phone','mobile','nationality', 'national_id','birth_cert_number','email','employer', 'employer_phone'
        ] 
